...
class ByBit:
    ...
    def main(self):
        ...
        while True:
            ...
            menu_table.add_row("[green]5. Start Script[/green]")
            menu_table.add_row("[blue]6. Abort Mission[/blue]")
            menu_table.add_row(Rule(style="bold yellow"))
            
            console.print(Panel(Align.center(menu_table), border_style="cyan", box=ROUNDED, width=60))
            
            choice = animated_input("[MRPTech]Enter your command: ")
